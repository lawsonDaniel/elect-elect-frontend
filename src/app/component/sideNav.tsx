...
export default function SideNav({ isMobileOpen }: SideNavProps) {
  ...
  >
    ...
    {/* Menu Text */}
    <div className={`text-xs sm:text-sm px-2 pt-2 pb-2 text-left ${isExpanded ? '' : 'text-center'} ${
      darkMode ? 'text-[#EDF3F8]' : 'text-[#6B7280]'
    }`}>
    ...
    <div className="flex-1 overflow-y-auto">
      ...
      {/* Chat Room */}
      <Link href="/dashboard/chat" className={`transition-all duration-1000 ease-in-out flex items-center px-3 sm:px-4 py-2 rounded-lg mx-2 mt-1 ${
      ...
      {/* Academics Text */}
      <div className={`px-2 pt-2 pb-2 text-left text-xs sm:text-sm ${isExpanded ? '' : 'text-center'} ${
      ...
      {/* CGP Calculator */}
      <Link href="/dashboard/gpaCalculator" className={`transition-all duration-1000 ease-in-out flex items-center px-3 sm:px-4 py-2 rounded-lg mx-2 mt-1 ${
      ...
      {/* Library */}
      <Link href="/dashboard/mini-library" className={`transition-all duration-1000 ease-in-out flex items-center px-3 sm:px-4 py-2 rounded-lg mx-2 mt-1 ${
      ...
      {/* Payments */}
      <Link href="/dashboard/payment" className={`transition-all duration-1000 ease-in-out flex items-center px-3 sm:px-4 py-2 rounded-lg mx-2 mt-1 ${
    ...
    <div className="mt-auto mb-4">
      {/* Settings */}
      <Link href="/dashboard/settings" className={`transition-all duration-1000 ease-in-out flex items-center px-3 sm:px-4 py-2 rounded-lg mx-2 ${
      ...
      {/* Log Out */}
      <Link href="/logout" className={`transition-all duration-1000 ease-in-out flex items-center px-3 sm:px-4 py-2 rounded-lg mx-2 mt-1 ${
        pathname === '/logout' 
          ? 'bg-navBlue text-white' 
          : `${darkMode ? 'text-[#EDF3F8] hover:bg-[#101E27]' : 'text-[#6B7280] hover:bg-gray-300'}`
      } ${isExpanded?'':'justify-center'}`}>
