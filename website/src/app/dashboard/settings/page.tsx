...
const profileValidationSchema = Yup.object({
  ...
  role: Yup.string()
    .oneOf(['Student', 'Faculty', 'Staff', 'Admin'], 'Invalid role selection')
      ...
      <div className="flex flex-col mt-1 w-full px-3 lg:pr-7 overflow-y-auto h-screen">
        ...
        <div className={`w-full ${poppins.className}`}>
          <div className="p-4 md:p-6">
            ...
            {/* Enhanced Password Management Tab */}
            {activeTab === 'password' && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
                <div className="mb-8">
                          ...
                          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                              <div className={`flex items-center gap-2 ${
                                values.newPassword.length >= 8 ? 'text-green-600' : 'text-gray-500'
                              }`}>
                                <div className={`w-1.5 h-1.5 rounded-full ${
                                  values.newPassword.length >= 8 ? 'bg-green-500' : 'bg-gray-300'
                                }`}></div>
                                At least 8 characters
                              </div>
                              <div className={`flex items-center gap-2 ${
                                /[A-Z]/.test(values.newPassword) ? 'text-green-600' : 'text-gray-500'
                              }`}>
                                <div className={`w-1.5 h-1.5 rounded-full ${
                                  /[A-Z]/.test(values.newPassword) ? 'bg-green-500' : 'bg-gray-300'
                                }`}></div>
                              ...
                              <div className={`flex items-center gap-2 ${
                                /\d/.test(values.newPassword) ? 'text-green-600' : 'text-gray-500'
                              }`}>
                                <div className={`w-1.5 h-1.5 rounded-full ${
                                  /\d/.test(values.newPassword) ? 'bg-green-500' : 'bg-gray-300'
                                }`}></div>
                                One number
                              </div>
                              <div className={`flex items-center gap-2 ${
                                /[!@#$%^&*(),.?":{}|<>]/.test(values.newPassword) ? 'text-green-600' : 'text-gray-500'
                              }`}>
                                <div className={`w-1.5 h-1.5 rounded-full ${
                                  /[!@#$%^&*(),.?":{}|<>]/.test(values.newPassword) ? 'bg-green-500' : 'bg-gray-300'
                                }`}></div>
